...
const SpeechASR = ({ serverUrl, isOnline }: SpeechASRProps) => {
...
*/
  ...
  const sendPromptToServer = async () => {
    ...
    const serverEndpoint = serverBaseUrl + '/recipes/speech_asr_url/';
  ...
  return (
    <>
      <Box className="app-container">
        <Box>
          <h2>Speech ASR - Automatic Speech Recognition</h2>
          <Divider />
